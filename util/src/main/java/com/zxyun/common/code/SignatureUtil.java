package com.zxyun.common.code;

import com.zxyun.common.utils.ArgumentUtils;
import com.zxyun.common.utils.MapUtil;
...
public class SignatureUtil {
    ...
    public static String generateSign(Map<String, String> map, String signKey, String signVal, String addKstring, String addVstring) {
        ...
        str = str + addVstring + (ArgumentUtils.isBlank(signKey) ? "" : signKey + addKstring) + signVal;
    ...
    public static String generateEventMessageSignature(String token, String timestamp, String nonce) {
        ...
        Arrays.sort(array);
        String s = ArgumentUtils.join(array, "");
